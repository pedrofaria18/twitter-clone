...
export const HashtagIcon = styled(Hashtag)`${iconCSS}`;
...
export const ListIcon= styled(ClipboardList)`${iconCSS}`;
export const MoreIcon= styled(DotsCircleHorizontal)`${iconCSS}`;
